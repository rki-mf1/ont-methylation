process modkit_pileup {
    ...
    script:
    //filter_threshold = params.automatic_threshold_modkit ? '' : '--filter-threshold'
    //filter_threshold_value = params.automatic_threshold_modkit ? '' : params.filter_threshold_modkit
